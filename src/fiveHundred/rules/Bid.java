 ...
 * 
 * <p>
 * This enables us to compare two bids naturally by their ordinal number to
 * verify which one is bigger, that is, has the highest score value.
 * 
 * @author Eric Perron
 * 
 */
public enum Bid {
	PASS("Pass", Trump.NO_TRUMP, 0), _6_PIQUES("6 Piques", Trump.SPADES, 40), _6_TREFLES("6 Trèfles", Trump.CLUBS, 60), _6_CARREAU(
			"6 Carreau", Trump.DIAMONDS, 80), _6_COEUR("6 Coeurs", Trump.HEARTS, 100), _6_SANS("6 Sans Atout",
			Trump.NO_TRUMP, 120), _7_PIQUES("7 Piques", Trump.SPADES, 140), _7_TREFLES("7 Trèfles", Trump.CLUBS, 160), _7_CARREAU(
			"7 Carreau", Trump.DIAMONDS, 180), _7_COEUR("7 Coeurs", Trump.HEARTS, 200), _7_SANS("7 Sans Atout",
			Trump.NO_TRUMP, 220), _8_PIQUES("8 Piques", Trump.SPADES, 240), _8_TREFLES("8 Trèfles", Trump.CLUBS, 260), _8_CARREAU(
			"8 Carreau", Trump.DIAMONDS, 280), _8_COEUR("8 Coeurs", Trump.HEARTS, 300), _8_SANS("8 Sans Atout",
			Trump.NO_TRUMP, 320), _9_PIQUES("9 Piques", Trump.SPADES, 340), _9_TREFLES("9 Trèfles", Trump.CLUBS, 360), _9_CARREAU(
			"9 Carreau", Trump.DIAMONDS, 380), _9_COEUR("9 Coeurs", Trump.HEARTS, 400), _9_SANS("9 Sans Atout",
			Trump.NO_TRUMP, 420), _10_PIQUES("10 Piques", Trump.SPADES, 440), _10_TREFLES("10 Trèfles", Trump.CLUBS,
			460), _10_CARREAU("10 Carreau", Trump.DIAMONDS, 480), _10_COEUR("10 Coeurs", Trump.HEARTS, 500), _10_SANS(
			"10 Sans Atout", Trump.NO_TRUMP, 520);
