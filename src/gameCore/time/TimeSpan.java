...
public class TimeSpan implements Comparable<Object>
{
	 ...
	 * 
	 * <p>
	 * The specified hours, minutes, and seconds are converted to ticks, and that value initializes
	 * this instance.
	 * 
	 * @param hours
	 ...
	 * 
	 * <p>
	 * The specified days, hours, minutes, and seconds are converted to ticks, and that value
	 ...
	 * 
	 * <p>
	 * The specified days, hours, minutes, seconds, and milliseconds are converted to ticks, and
	 ...
	 * 
	 * <p>
	 * This is a convenience method with the same behavior as the TimeSpan.TimeSpan(long)
	 * constructor. A single tick represents one hundred nanoseconds or one ten-millionth of a
	 ...
	 * 
	 * <p>
	 * The resulting value must be between TimeSpan.MIN_VALUE and TimeSpan.MAX_VALUE; otherwise, an
	 * exception is thrown.
	 * 
	 * @param ts
