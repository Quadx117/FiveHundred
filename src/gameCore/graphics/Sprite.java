...
public class Sprite {
	...
	// Horizontal cards
	public static Sprite cardBack_Blue_hor = new Sprite(106, 80, 0, 0, SpriteSheet.cardBack_Horizontal);
	public static Sprite cardBack_Red_hor = new Sprite(106, 80, 1, 0, SpriteSheet.cardBack_Horizontal);

	// Card highlight for selected card
	public static Sprite cardHighlight = new Sprite(85, 110, 0, 0, SpriteSheet.cardHighlight);
