...
{
	// TODO: Change the way sprites and spritesheets are created
	// Cards Sheets here:
	public static SpriteSheet cardSet = new SpriteSheet("/images/cards/cardSet.png", 1040, 530);
	public static SpriteSheet cardBack_Horizontal = new SpriteSheet("/images/cards/cardBack_Horizontal.png", 636, 80);
	public static SpriteSheet cardHighlight = new SpriteSheet("/images/cards/cardHighlight.png", 85, 110);
	...
	/** Width and height of a SpriteSheet */
